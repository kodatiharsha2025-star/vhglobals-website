        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 text-xs text-slate-600 font-mono py-3 px-4 rounded-lg bg-slate-50 border border-slate-200 max-w-2xl mx-auto">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-slate-800 font-medium">under 24hours to 48hours Video Turnaround</span>
            </div>
          </div>
        </div>

        {/* How It Works Section Header */}
        <div id="how-it-works" className="text-center max-w-3xl mx-auto mt-20 sm:mt-24 mb-6 sm:mb-8">
          ...
          <p className="text-base sm:text-lg text-slate-700 leading-relaxed max-w-3xl mx-auto font-normal">
            We transition your business from manual work to an automated growth engine through professional video editing retainers and dedicated AI voice agents.
          </p>
        </div>
