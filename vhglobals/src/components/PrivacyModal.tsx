import { X, ShieldCheck, Mail, Globe, Phone, Building } from 'lucide-react';
        ...
        <div className="p-6 sm:p-8 overflow-y-auto space-y-6 text-sm text-slate-700 leading-relaxed font-sans bg-white">
          ...
          <div className="space-y-2">
            ...
            <p className="text-slate-700 text-xs sm:text-sm">
              This Privacy Policy explains how <strong>VHGLOBALS</strong> collects, uses, and protects information when you interact with our services via <span className="text-[#0a0a0a] font-mono font-bold">vhglobals.com</span>.
            </p>
          </div>
          ...
          <div className="space-y-3 border-t border-slate-200 pt-5 bg-slate-50 p-5 rounded-xl border border-slate-200">
            ...
            <p className="text-xs sm:text-sm text-slate-700">
              Any privacy-related inquiries or requests to exercise your data rights can be directed to our official contact channels:
            </p>
            <div className="text-xs font-mono space-y-2 pt-2 text-slate-800">
